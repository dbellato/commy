...
$azureAiChatDeploymentName = azd env get-value AZURE_AI_CHAT_DEPLOYMENT_NAME 2>$null
...
$azureAISearchIndexNameSpecs = azd env get-value AZURE_AI_SEARCH_INDEX_NAME_SPECS 2>$null
...
Add-Content -Path $envFilePath -Value "AZURE_AI_SEARCH_INDEX_NAME_SPECS=$azureAISearchIndexNameSpecs"
